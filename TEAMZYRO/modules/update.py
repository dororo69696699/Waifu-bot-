...
from TEAMZYRO.unit.zyro_rarity import rarity_map, rarity_map2, update_rarity_limit, get_rarity_limit, get_all_rarity_limits

# Keep existing commands unchanged
@app.on_message(filters.command("gdelete"))
@require_power("del")
async def delete_handler(client, message):
    # [KEEP THIS EXACTLY AS IS - UNCHANGED]
    try:
...
# ==========================================
# 🔥 FIXED: /maxupdate NOW UPDATES RARITY LIMITS
# ==========================================
...
# ==========================================
# OPTIONAL: Command to reset all limits to defaults
# ==========================================

@app.on_message(filters.command("resetrarities") & filters.owner)
async def reset_rarities_command(client: Client, message: Message):
    """Reset all rarity limits to default values"""
    try:
